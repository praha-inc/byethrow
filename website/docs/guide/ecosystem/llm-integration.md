...
Add the following configuration to your VS Code MCP config file. See the [VS Code MCP documentation](https://code.visualstudio.com/docs/copilot/customization/mcp-servers) for more details.
...
Alternatively, paste the following configuration into your `~/.cursor/mcp.json` file. For project-specific installation, create `.cursor/mcp.json` in your project folder. See the [Cursor MCP documentation](https://docs.cursor.com/context/model-context-protocol) for more information.
...
Add this to your Windsurf MCP config file. See [Windsurf MCP docs](https://docs.windsurf.com/windsurf/cascade/mcp#mcp_config-json) for more info.
